...
const Home = () => {
  const features = [
    ...
    },
    {
      ...
      title: "IA Mystique",
      description: "Interprétations personnalisées par intelligence artificielle"
    },
    {
    ...
    <div className="min-h-screen pt-16 relative overflow-hidden">
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            Découvrez les secrets de votre destinée à travers les cartes sacrées du tarot, 
            guidé par l'intelligence artificielle et bercé par des mélodies mystiques
          </motion.p>
